...
Depending on which VPC you are operating in, deployed instances will or will not have a public ip address attached to them by default. Any instance deployed in the default VPC will have a public ip address attached.
Any instance launched in a non-default VPC will not, unless you specify that it should.
